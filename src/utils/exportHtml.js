...
<div class="container">
  ...
  <div style="text-align:center;margin-top:60px;padding-top:24px;border-top:1px solid #1e2d3d;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:2px;color:#3a4a5a;">
    Generated by BookFilm Studio &mdash; All images, video, and voice in this document are AI-generated synthetic media. Disclose AI origin when publishing per applicable platform rules and regulations (e.g. EU AI Act).
  </div>
</div>
</body>
</html>`
