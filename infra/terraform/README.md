...
## What it creates
- A GPU EC2 instance from the latest **Deep Learning Base GPU AMI** (NVIDIA driver + Docker + nvidia-container-toolkit preinstalled).
...
- **Cost**: `g5.xlarge` ≈ $1/hr on-demand. `terraform destroy` when idle, or stop the instance. Consider Spot for non-critical render workers.
